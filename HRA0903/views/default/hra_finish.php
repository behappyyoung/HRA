...
$dietpara = array(
        'h2_code' => $myResult['diet_plan'],
        'h2_id' => $myResult['diet_plan_detail']['id'],
        'h2_name' => $myResult['diet_plan_detail']['name'],
        'min_cal' => $myResult['diet_plan_detail']['min_calories'],
        'max_cal' => $myResult['diet_plan_detail']['max_calories'],
);

$result2 = H2hra::saveDietplan($dietpara);
              ...
              <div class="form-table">
                  ...
                  <?php
                    foreach($myResult as $key => $value){
                        echo '<div> <div class="label">  <span class="space">  </span> <span class="required-label"> '.$key.' </span> </div>';
                        echo '<div class="input"> '.$value.' </div></div>';
                    }
                  ?>
